          ...
          <div className="flex flex-col items-center gap-8 max-lg:justify-center min-[500px]:flex-row min-[500px]:items-start sm:gap-12 md:px-4 xl:gap-24">
            {FooterMenu.map((menu, index) => (
              <div key={index} className="block">
                <h4 className="mb-4 text-center font-fontOpen text-base text-[#FFFFFF66] min-[500px]:text-left">{menu.title}</h4>
                <ul className="grid gap-0 text-center font-fontOpen text-14 min-[500px]:gap-1 min-[500px]:text-left">
                  {menu.links.map((link, index) => (
                    <li key={index}>
                      <a href={link.link} className="text-white hover:text-palletteColor1">
                        {link.title}
                      </a>
                    </li>
                  ))}
            ...
            <div className="block w-64">
              <h4 className="mb-4 text-center font-fontOpen text-base text-[#FFFFFF66] min-[500px]:text-left">Contact Us</h4>
              <div className="flex flex-col gap-4">
                <div className="flex items-center rounded-[0.8rem] bg-[#3E3E47] p-1 font-fontOpen">
                  <div className="p-2">
                    <img className="size-5" src="/footer/Calling.png" alt="" />
                  </div>
                  <div className="border-l border-gray-500">
                    <div className="ml-2">
                      <p className="text-[0.625rem] text-[#FFFFFF66]">Phone</p>
                      <p className="text-[0.75rem] text-white">(222)222-2222</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center rounded-[0.8rem] bg-[#3E3E47] p-1 font-fontOpen">
                  <div className="p-2">
                    <img className="size-5" src="/footer/Message.png" alt="" />
                  </div>
                  <div className="border-l border-gray-500">
                    <div className="ml-2">
                      <p className="text-[0.625rem] text-[#FFFFFF66]">Email</p>
                      <p className="text-[0.75rem] text-white">support@buckets.com</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="w-full bg-[#24242B]">
        <div className="container mx-auto flex flex-col items-center justify-center gap-8 px-4 py-2 sm:px-6 lg:flex-row lg:justify-between lg:gap-0 lg:px-12">
          ...
          <div className="mt-4 flex space-x-4 text-white sm:mt-0 sm:justify-center">
            <a href="#">
              <span className="font-fontOpen underline hover:text-gray-500">Terms of Use</span>
            </a>
            <a href="#">
              <span className="font-fontOpen underline hover:text-gray-500">Privacy Policy</span>
            </a>
          </div>
        </div>
      </div>
