                    ...
                    <div className="relative h-fit">
                        <div className="z-10 mt-36 md:ml-8">
                            ...
                            <p className="z-10 mb-8 text-center text-base text-[#928F8F] md:px-6 md:text-left md:text-xl lg:px-1">
                                Drive Buisness Success with Our Efficient and
                            ...
                            <div className="mb-16 mt-20 flex justify-center gap-8 md:flex-row md:justify-start md:gap-16 lg:gap-20">
                                <div className="space- z-10 flex flex-col space-y-4">
                                    ...
                                    <span className="font-fontOpen text-sm font-medium text-[#909090] md:text-18">
                                        Years Experience
                                    </span>
                                </div>
                                <div className="flex flex-col space-y-4">
                                    ...
                                    <span className="z-10 font-fontOpen text-sm font-medium text-[#909090] md:text-18">
                                        Cases Solved
                                    </span>
                                </div>
                                <div className="flex flex-col space-y-4">
                        ...
                        <img
                            className="absolute top-0 z-0 md:right-0 lg:-right-60"
