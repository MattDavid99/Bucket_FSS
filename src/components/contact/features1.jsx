  ...
  return (
    <section className="container relative m-auto mt-12 px-4 py-10 md:px-14">
      <div className="mb-4 text-center">
        ...
        <h1 className="font-fontOpen text-heading2 font-bold text-palletteColor9">How can we help?</h1>
      </div>

      <div className="mt-14 grid gap-12 sm:grid-cols-2 xl:grid-cols-3 xl:gap-16">
        <div className="flex flex-col items-center">
          <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-[#82ce51] text-white shadow-lg md:h-14 md:w-14 md:rounded-md">
          ...
          <h3 className="mb-2 text-center font-fontOpen text-heading3 font-bold text-palletteColor9 md:text-heading3">Sales</h3>
          <p className="mb-2 text-center font-fontOpen text-base text-palletteColor5">
            Our knowledgeable sales team is here to answer your questions. Learn more about boosting your business today!
          </p>
          <Button variant="secondary"> Contact Sales {'>'}</Button>
        </div>
        <div className="flex flex-col items-center">
          <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-[#82ce51] text-white shadow-lg md:h-14 md:w-14 md:rounded-xl">
        ...
        <div className="flex flex-col items-center">
          <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-[#82ce51] text-white shadow-lg md:h-14 md:w-14 md:rounded-xl">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 288 512">
              <path
                fill="#FFF"
          ...
          <h3 className="mb-2 text-center font-fontOpen text-heading3 font-bold text-palletteColor9 md:text-heading3">Pricing</h3>

          <p className="mb-2 text-center font-fontOpen text-base text-palletteColor5">
            Affordable options for businesses of any size. Customizable plans and flexible payments available. Boost your business now!
          </p>
