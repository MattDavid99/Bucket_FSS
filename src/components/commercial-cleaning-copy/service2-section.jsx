            ...
            <div className="grid grid-cols-1 grid-rows-1 items-center gap-6 md:grid-cols-2">
                <div className="">
                    ...
                    <p className="mt-4 font-fontRoboto text-base text-palletteColor9">
                        Let our plumbing scheduling software work for you with
                        online booking, enabling fast and easy scheduling.
                        Easily dispatch the right plumber to each job while
                    ...
                    <ul className="mt-4 space-y-2 font-fontOpen text-base text-palletteColor9">
                        <li className="flex gap-2">
                            ...
                            <div>
                                <span className="font-bold text-palletteColor9">
                                    Quickly schedule appointments{" "}
                                </span>
                                with online booking or drag-and-drop calendar
                                view in the app
                            </div>
                        </li>
                        <li className="flex gap-2">
                            ...
                            Give your customers the convenience they crave with
                            the ability to book your services 24/7
                        </li>
                        <li className="flex gap-2">
                            <svg
                                className="size-4"
                            ...
                            Dispatch the right person to the right job based on
                            their real-time location and status
                        </li>
                    </ul>
                ...
                <div>
                    <img
                        src="/commercial-cleaning-copy/service2.jpg"
                        width="100%"
                        height="100%"
                        alt=""
                    />
