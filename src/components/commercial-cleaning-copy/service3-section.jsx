            ...
            <div className="grid grid-cols-1 grid-rows-1 items-center gap-6 md:grid-cols-2">
                <div className="order-1">
                    ...
                    <p className="mt-4 font-fontRoboto text-base text-palletteColor9">
                        Our ‘Good, Better, Best’ feature makes it easy to
                        showcase tiered pricing options so your customers can
                        easily visualize the benefits and features that come
                        with each service. When your invoice perfectly matches
                        the original estimate, you can close more jobs quickly
                        and easily.
                    </p>
                    <ul className="mt-4 space-y-2 font-fontOpen text-base text-palletteColor9">
                        <li className="flex gap-2">
                            ...
                            You or your team can easily create custom plumbing
                        ...
                        <li className="flex gap-2">
                            ...
                            Ensure you have jobs all year long & never worry
                            about a slow season with recurring service plans
                        </li>
                    </ul>
                ...
                <div>
                    <img
                        src="/commercial-cleaning-copy/service3.jpg"
                        width="100%"
                        height="100%"
                        alt=""
                    />
