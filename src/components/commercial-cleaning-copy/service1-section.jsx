            ...
            <div className="grid grid-cols-1 grid-rows-1 items-center gap-6 md:grid-cols-2">
                <div className="order-2">
                    ...
                    <p className="mt-4 font-fontOpen text-base text-palletteColor9">
                        Whether your biggest challenge is scheduling jobs,
                        dispatching techs, or collecting payments, our plumbing
                        software can help you manage it all. Buckets Pro has all
                        the cutting-edge features you need to manage plumbing
                        operations, enhance productivity, and improve customer
                        service.
                    </p>
                    <ul className="mt-4 space-y-2 font-fontOpen text-base text-palletteColor9">
                        <li className="flex gap-2">
                            ...
                            Make informed, data-driven decisions with real-time
                        ...
                        <li className="flex gap-2">
                            ...
                            Easily keep track of jobs and your team, no matter
                            where you are
                        </li>
                        <li className="flex gap-2">
                            <svg
                            ...
                            No more manual data entry, streamline team
                            management from time tracking to payroll
                        </li>
                        <li className="flex gap-2">
                            <svg
                                className="size-4"
                            ...
                            Easily connect Housecall Pro with your other
                            software tools
                        </li>
                    </ul>
                ...
                <div>
                    <img
                        src="/commercial-cleaning-copy/service1.jpg"
                        width="100%"
                        height="100%"
                        alt=""
                    />
