...
const GetInTouch = () => {
  ...
  const FeatureItem = ({ feature }) => (
    <div className="flex flex-col items-center text-center max-w-[200px]">
      <div className="bg-palletteColor1/50 rounded-lg p-2 mb-2">
        <img src={feature.image} className="w-12 h-12 transform transition-transform duration-300 hover:scale-x-[-1]" alt={feature.alt} />
      </div>
  ...
  return (
    <section className="relative mt-12 lg:mt-28 h-fit bg-palletteColor10 py-14 md:py-16">
