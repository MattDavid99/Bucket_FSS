    ...
    return (
        <div className="relative mt-4 h-fit bg-palletteColor10 px-14 py-28">
            <div className="flex flex-col items-center justify-center">
                ...
                <h2 className="mb-6 text-center font-fontOpen text-heading2 font-bold text-palletteColor9 md:text-left">
                    Let us earn your trust
                </h2>
                <p className="mb-6 text-center font-fontOpen text-palletteColor5 md:text-left">
                    Buckets has your back every step of the way. Take the next
                    step for your home cleaning business!
                </p>
