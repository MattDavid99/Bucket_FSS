        ...
        <div className="container relative m-auto mt-12 px-4 py-10">
            ...
            <div className="mt-8 flex flex-col gap-3 md:flex-row md:gap-6">
                <div className="order-1">
                    ...
                    <h2 className="mt-2 font-fontPoppins text-heading4 font-medium leading-[2.188rem] text-palletteColor9">
                        &quot;I absolutely love this app and the crew behind it!
                        Every single person that I have interacted with at
                        Buckets has been phenomenal! Definitely a partner for
                        life. &quot;
                    </h2>
