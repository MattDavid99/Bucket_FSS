...
const buttonVariants = cva(
  ...
  'font-bold cursor-pointer text-center transition-all duration-500',
  {
    variants: {
      variant: {
        primary: 'bg-[#82ce51] text-white hover:bg-[#88a444] hover:text-black rounded-[2.5rem] shadow-xs py-3 px-[2.12rem]',
        secondary: 'text-palletteColor1 hover:text-palletteColor5 hover:scale-110 transform mt-2 font-fontbase',
      },
      size: {
        default: 'text-base',
        small: 'text-sm',
