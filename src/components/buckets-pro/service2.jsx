...
const servicesItems = [
    ...
    },
    {
        ...
        content:
            "Track leads from first contact to final sale, and turn more prospects into customers with automated follow-ups",
    },
]
                ...
                <div className="order-1">
                    ...
                    <div className="my-4">
                        <p className="text-center font-fontOpen text-base text-palletteColor6 md:text-left">
                            ...
                            quickly find details from past jobs, keep organized
                            records of client communication, and turn sales
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                <img
                                                    ...
                                                    alt=""
                                                />
                                                <h5 className="font-fontOpen text-14 font-semibold">
                                                    {item.title}
                                                </h5>
                                            </div>
