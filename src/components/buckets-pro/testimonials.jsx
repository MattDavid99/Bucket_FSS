        ...
        <div className="relative mt-4 h-fit bg-palletteColor10 px-14 py-24">
            <div className="container mx-auto">
                <div className="mb-2 text-center">
                    ...
                    <h1 className="font-Open text-headingMobile font-bold text-palletteColor9 md:text-heading1">
                        Testimonials
                    </h1>
                </div>
                <div>
                            ...
                            <div key={index} className="mx-4">
                                <div className="rounded-[0.625rem] border border-gray-300 bg-white p-6">
                                    <div className="flex flex-col">
                                        ...
                                        <h3 className="mt-4 font-fontOpen text-18 text-black">
                                            {testimonial.name}
                                        </h3>
                                        <p className="mb-4 mt-2 font-fontOpen text-heading6 text-palletteColor13">
                                        ...
                                        <div className="mb-4">
                                            <Stars
                                                color="#008CFF"
                                                number={testimonial.stars}
                                            />
                                        </div>

                                        <p className="font-fontOpen text-heading6 text-palletteColor13">
                                            Before we had Buckets. a lot of our
                                            issues were trying to get all our
                                            customers into one database.
                                        </p>
                                    </div>
                                </div>
                            </div>
